...
| `0x530BF0` | `Field_ObjectInPath` | `FUN_801B53C8` | 0x98 | 11 | the object at a point, if reachable |
...
`Field_ObjectInPath`: `Sprite_ObjectAt` at the point, refused for kind 8, a
...
- **`Field_ObjectInPath` compares the index signed** with 30: an answer of 0x80
