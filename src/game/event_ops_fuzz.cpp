...
const Clone kClones[kFns] = {
    ...
    {"Field_ObjectInPath", 0x530BF0, 0x98, {{0x16, 0x531CF0}}, 0, 0, 0, 0},
...
void UseRegions(unsigned mask) {
    ...
    if (mask & kFar)                                          // Field_ObjectInPath's answers read either way
...
const Test kTests[] = {
    ...
    {kObjectAhead, kObj | kExt | kFar, reinterpret_cast<void*>(&Field_ObjectInPath)},
