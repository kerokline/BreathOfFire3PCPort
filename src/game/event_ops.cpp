...
const Callees kOriginals = {
    ...
    Party_CanSwap, Field_EffectAhead, Area_PassageAhead, Field_FacingObject, Field_ObjectAhead, Field_CellAround,
...
extern "C" unsigned char __cdecl Field_ObjectAhead(long x, long z, unsigned) {
