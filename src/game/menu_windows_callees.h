...
constexpr std::uint32_t kIconRects = 0x66367C;    // Menu_DrawBigIcon's (u, v, clut x << 4, clut y - 0x1E0)
...
struct Callees {
    ...
    void (__cdecl* icon)(int, int, int, int);                                                 // Menu_DrawBigIcon
    int (__cdecl* exp_for_level)(unsigned, unsigned);                                         // Char_ExpForLevel
    unsigned (__cdecl* item_price)(unsigned, unsigned);                                       // Item_BasePrice
